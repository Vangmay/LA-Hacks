...
class Settings(BaseSettings):
    ...
    deepdive_dynamic_roster_enabled: bool = True
    ...
    deepdive_stage_timeout_seconds: int = 3600
    ...
    deepdive_model_timeout_seconds: float = 300.0
    deepdive_model_max_retries: int = 8
    deepdive_model_retry_max_delay_seconds: float = 120.0
    deepdive_tool_result_char_limit: int = 10000
    deepdive_workspace_write_char_budget: int = 20000
    deepdive_subagent_max_workspace_tool_calls: int = 10000
    deepdive_subagent_max_steps: int = 3000
    ...
    deepdive_thinking_min_interval_seconds: float = 0.25
    ...
    deepdive_light_min_interval_seconds: float = 0.25
    deepdive_max_output_tokens_thinking: int = 32768
